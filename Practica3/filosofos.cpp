  ...
  while ( true )
   {
      ...
      cout <<"Filósofo " <<id << " solicita ten. 1." <<id_ten_1 <<endl;
      MPI_Ssend( &peticion, 1, MPI_INT, id_ten_1, 0, MPI_COMM_WORLD );

      cout <<"Filósofo " <<id <<" solicita ten. 2." <<id_ten_2 <<endl;
      MPI_Ssend( &peticion, 1, MPI_INT, id_ten_2, 0, MPI_COMM_WORLD );

      cout <<"Filósofo " <<id <<" comienza a comer" <<endl ;
      sleep_for( milliseconds( aleatorio<10,100>() ) );

      cout <<"Filósofo " <<id <<" suelta ten. 1. " <<id_ten_1 <<endl;
      MPI_Ssend( &peticion, 1, MPI_INT, id_ten_1, 0, MPI_COMM_WORLD );

      cout<< "Filósofo " <<id <<" suelta ten. 2. " <<id_ten_2 <<endl;
      MPI_Ssend( &peticion, 1, MPI_INT, id_ten_2, 0, MPI_COMM_WORLD );
